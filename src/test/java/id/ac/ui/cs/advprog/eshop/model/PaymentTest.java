...
public class PaymentTest {
    ...
    void testCreatePaymentDefaultStatus() {
        Payment payment = new Payment("c538eb78-b80a-4a3b-a487-696662cd4419", PaymentMethod.VOUCHER.getValue(), order, this.paymentData);
    ...
    void testCreatePaymentSuccessStatus() {
        Payment payment = new Payment("c538eb78-b80a-4a3b-a487-696662cd4419", PaymentMethod.VOUCHER.getValue(),
